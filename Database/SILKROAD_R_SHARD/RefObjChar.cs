...
public partial class RefObjChar
{
    ...
    public byte CanStoreTid1 { get; set; }

    public byte CanStoreTid2 { get; set; }

    public byte CanStoreTid3 { get; set; }

    public byte CanStoreTid4 { get; set; }
    ...
    public int KoRecoverTime { get; set; }
    ...
    public int? DefaultSkill4 { get; set; }

    public int? DefaultSkill5 { get; set; }

    public int? DefaultSkill6 { get; set; }

    public int? DefaultSkill7 { get; set; }

    public int? DefaultSkill8 { get; set; }

    public int? DefaultSkill9 { get; set; }

    public int? DefaultSkill10 { get; set; }

    public byte? TextureType { get; set; }

    public int? Except1 { get; set; }

    public int? Except2 { get; set; }

    public int? Except3 { get; set; }

    public int? Except4 { get; set; }

    public int? Except5 { get; set; }

    public int? Except6 { get; set; }

    public int? Except7 { get; set; }

    public int? Except8 { get; set; }

    public int? Except9 { get; set; }

    public int? Except10 { get; set; }
