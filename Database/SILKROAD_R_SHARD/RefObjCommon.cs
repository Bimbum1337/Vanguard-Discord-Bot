...
public partial class RefObjCommon
{
    ...
    public virtual ICollection<RefAbilityByItemOptLevel> RefAbilityByItemOptLevels { get; set; } = new List<RefAbilityByItemOptLevel>();

    public virtual ICollection<RefGiftExchangeCoupon> RefGiftExchangeCoupons { get; set; } = new List<RefGiftExchangeCoupon>();
