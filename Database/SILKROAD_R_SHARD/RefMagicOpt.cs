...
public partial class RefMagicOpt
{
    ...
    public string MoptName128 { get; set; } = null!;

    public string AttrType { get; set; } = null!;
    ...
    public string AvailItemGroup1 { get; set; } = null!;

    public int ReqClass1 { get; set; }

    public string AvailItemGroup2 { get; set; } = null!;

    public int ReqClass2 { get; set; }

    public string AvailItemGroup3 { get; set; } = null!;

    public int ReqClass3 { get; set; }

    public string AvailItemGroup4 { get; set; } = null!;

    public int ReqClass4 { get; set; }

    public string AvailItemGroup5 { get; set; } = null!;
    ...
    public virtual ICollection<RefAlchemyCorrection> RefAlchemyCorrections { get; set; } = new List<RefAlchemyCorrection>();
}
