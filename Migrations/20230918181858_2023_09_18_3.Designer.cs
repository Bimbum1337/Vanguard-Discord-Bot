...
namespace BimBot.Migrations
{
    ...
    [Migration("20230918181858_2023_09_18_3")]
    partial class _2023_09_18_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BimBot.Database.SRO_VT_BIMBOT.Giveaway", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("SecondsLeft")
                        .HasColumnType("decimal(20,0)");
                    ...
                    b.HasKey("ID")
                        .HasName("PK_dbo._Giveaway");

                    b.ToTable("_Giveaway", (string)null);
                });

            modelBuilder.Entity("BimBot.Database.SRO_VT_BIMBOT.GiveawayRecords", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Giveaway_ID")
                        .HasColumnType("int");

                    b.Property<bool>("IsRewardTaken")
                        .HasColumnType("bit");
                    ...
                    b.HasKey("ID")
                        .HasName("PK_dbo._GiveawayRecords");

                    b.HasIndex("Giveaway_ID");

                    b.ToTable("_GiveawayRecords", (string)null);
                });
            ...
            modelBuilder.Entity("BimBot.Database.SRO_VT_BIMBOT.GiveawayRecords", b =>
                {
                    b.HasOne("BimBot.Database.SRO_VT_BIMBOT.Giveaway", "Giveaway")
                        .WithMany("Records")
                        .HasForeignKey("Giveaway_ID")
                        .IsRequired()
